...
void VideoCamSelectionApp::setupCapture( Capture::DeviceRef device )
{
...
bool VideoCamSelectionApp::setupCaptureWithMode( Capture::DeviceRef device, const Capture::Mode& mode )
{
...
void VideoCamSelectionApp::updateModes()
{
    mCurrentModes.clear();
